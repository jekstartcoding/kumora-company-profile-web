              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="block"
                  >
                    <div className="aspect-[16/10] w-full overflow-hidden bg-blush lg:aspect-[4/3]">
                      <img
                        src={cat.image}
                        alt={cat.name}
                        loading="lazy"
                    ...
                    <div className="absolute inset-x-0 bottom-0 p-5 md:p-6">
                      ...
                      <span className="mt-3 inline-flex items-center gap-1.5 text-xs font-medium text-mauve transition-[gap,color] duration-300 ease-out group-hover:gap-2.5">
